	...
	<div class="mx-auto max-w-7xl py-16 px-4 sm:py-24 sm:px-6 lg:flex lg:justify-between lg:px-8">
		<div class="max-w-xl">
			...
			<p class="mt-5 text-xl text-gray-400">
				Learn from the source. Find inspiration for your next project by looking at these
				repositories.
			</p>
		</div>
	</div>
			...
			<div class="overflow-hidden rounded-lg bg-white px-4 py-6 shadow lg:px-8 lg:py-4">
				<div>
					<a href="#" class="inline-block">
						<span
							class="inline-flex items-center rounded-full bg-pink-100 px-3 py-0.5 text-sm font-medium text-pink-800"
						>
							Video
						</span>
					</a>
